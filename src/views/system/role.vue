  ...
  <BaseContainer>
    ...
    <el-dialog :title="form.title" :visible.sync="form.dialog" width="30%">
      <el-form ref="form" :model="form.data" :rules="form.rules" label-width="80px">
        <el-form-item label="角色名称" prop="roleName">
          <el-input v-model="form.data.roleName" placeholder="请输入角色名称"></el-input>
        </el-form-item>
        <el-form-item label="角色编码" prop="roleCode">
          <el-input v-model="form.data.roleCode" placeholder="请输入角色编码"></el-input>
        </el-form-item>
        <el-form-item label="排序" prop="sort">
          <el-input-number v-model="form.data.sort" placeholder="请输入排序"></el-input-number>
        </el-form-item>
        <el-form-item>
...
<script>
import { apiPage, apiDelete, apiSave, apiUpdate } from '@/api/system/role'
